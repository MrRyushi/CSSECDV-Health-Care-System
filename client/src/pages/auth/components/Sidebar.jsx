...
function Sidebar(props) {
  ...
  return (
    <nav
      className="flex flex-col w-64 px-12 pt-4 pb-6 navbar"
      style={{
        boxShadow:
    ...
    >
      <div className="mt-10">
        ...
        <img
          ...
          src={pfp}
        ></img>
        <h1 className="mx-auto text-center uppercase text-2xl text-blue-800 font-bold">
          {props.name}
        </h1>
      </div>
      <div className="mt-12 space-y-12">
        {selected == "dashboard" ? (
          <div className="w-52 h-10 bg-indigo-600 bg-opacity-60 rounded-tl-[19px] rounded-bl-[19px] shadow ps-2 pt-1">
            <button
              className="text-xl "
              onClick={() =>
                props.changeSelected("dashboard")
              }
            >
              {house}
            </button>
            <button
              className="text-xl ms-3 exo"
              onClick={() =>
                props.changeSelected("dashboard")
              }
            >
        ...
        <div className="mt-3">
          <button
            className="text-xl me-10 w-52 h-10 hover:bg-indigo-300 hover:bg-opacity-60 hover:rounded-tl-[19px] hover:rounded-bl-[19px] ps-2 pt-1"
